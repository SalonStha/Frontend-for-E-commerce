...
import categoryervice from "../../services/brand.service";
...
const UpdateCategory = () => {
    ...
    const submitForm = async (data: ICategoryData) => {
        ...
        try {
            await categoryervice.putRequest('category/' + params.id, formData, {
                headers: {
    ...
    const getCategory = async () => {
        try {
            const response = await categoryervice.getRequest('category/' + params.id);
