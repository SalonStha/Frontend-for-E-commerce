...
function LoginPage() {
    const [data, setData] = useState<ICredentials>({  // Initializing state with an empty credentials object
        email: '',
        password: '',
    ...
    useEffect(() => {
        ...
        console.log("Sasto Bazzar - Login"); // Set the document title for the login page
        setTimeout(() => {
            setLoading(false); // Simulate loading state after 2 seconds
        }, 2000);
    ...
    useEffect(() => {
        console.log('I am called when data changes:', data);
    }, [data]); // This effect runs only when 'data' changes, which is currently never since 'data' is not updated in this component
        ...
        <>
            <div className="font-poppins flex w-full h-screen flex-col items-center justify-center bg-gray-200">
                ...
                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                    <div className="sm:mx-auto sm:w-full rounded-md sm:max-w-sm bg-white p-8 shadfont-mediumded-lg">
                        ...
                        <form className="space-y-6" action="#" method="POST">
                            ...
                            <div>
                                ...
                                <div className="mt-2 text-right">
                                    <a href="/forgot-password" className="text-sm font-semibold text-indigo-600 hover:text-indigo-500">Forgot Password?</a>
                                </div>
                            </div>
                        ...
                        <div>
                            <button type="submit" className="mb-2 flex w-full items-center justify-center border-1 rounded-md p-2 cursor-pointer text-sm border-gray-400 gap-5">
                        ...
                        <p className="mt-10 text-center text-sm text-gray-500">
                            New to our site?
                            <a href="/signup" className="font-semibold leading-6 pl-1 text-indigo-600 hover:text-indigo-500">Sign up now</a>
                        </p>
                    </div>
                </div>
            </div>
